...
#include <memory>
#include "../../Monitoring_Platform/framework/statusbar.h"
...
QT_MOC_LITERAL(1, 10, 12), // "onshowStatus"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5) // "index"

    },
    "StatusBar\0onshowStatus\0\0index"
};
...
void StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onshowStatus((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
