...
#include <memory>
#include "../../Monitoring_Platform/User/users.h"
...
QT_MOC_LITERAL(3, 15, 17), // "onRegisterClicked"
QT_MOC_LITERAL(4, 33, 14) // "onCloseClicked"

    },
    "Users\0display\0\0onRegisterClicked\0"
    "onCloseClicked"
};
...
void Users::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Users::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Users::display)) {
                *result = 0;
                return;
            }
        }
